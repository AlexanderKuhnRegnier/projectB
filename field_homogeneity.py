...
import os
plt.ioff()
from EDM import create_EDM_system
...
system,dust_size = create_EDM_system((26*factor,3*factor),k,
                                     ...
                                     dust_size=2.)
#system.show_setup()
system.SOR_single(w=1.2,tol=1e-14,max_time=10)
#system.show()
...
plt.figure()
plt.plot(np.linspace(0,system.size[0],len(beam_path)),beam_path)
...
print('total size:',beam_path.size)
...
#    print('sections:',sections)
    ...
    section_lengths = (section_ends-section_starts)*system.h*system.size[0]
